...
def peroxide_workflow(reagent_incubation_time=1*60,sample_incubation_time=1*60,interval=5*60,replicates=3): #Reagent incubation time=20 mins; sample incubation time is 18 mins; sample platereading interval is 5 mins.
    ...
    #Step 3: Add 150 µL "Working Reagent" (vial_index 1) to 950 µL deionized water (vial_index 3-8) to dilute the Working Reagent.
    ...
    #Step 4: Move the reaction mixture vial (reaction_mixture_index) to the photoreactor to start the reaction.
    ...
    #Step 5: Add 200 µL "reaction mixture" (vial in the photoreactor) to "Diluted Working Reagent" (vial_index 3-8). 
