...
EXPORT_FILEPATH = r"C:\Users\Imaging Controller\Desktop\utoronto_demo\Calibration Data\Calibration Jan 2025\calibration_water_250_dispenseall_2.txt" #put solvent, dispense_method, into notes
#ASPIRATE_VOLUMES = [0.75, 0.5, 0.4, 0.3, 0.2, 0.1, 0.05]
ASPIRATE_VOLUMES = [0.04, 0.03, 0.02, 0.01]
REPLICATES = 3

ASPIRATE_VOLUMES_MULTI = [[1, 0.5, 0.2, 0.15, 0.1, 0.050, 0.025]]
...
multi_dispense_calibration(input_vial_status_file="../utoronto_demo/status/vial_status_wellplate - test.txt", source_vial = 0, aspirate_volume_list=ASPIRATE_VOLUMES_MULTI, replicates=REPLICATES , dest_vial_position=1, export_path = EXPORT_FILEPATH, buffer=0)