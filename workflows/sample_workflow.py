...
def sample_workflow(input_vial_status_file, source_vials, aspirate_volumes, dest_vial_position, well_plate_array,reactor_time,cytation_protocol_file_path):
    ...
    lash_e.nr_robot.aspirate_from_vial(dest_vial_position,aspirate_volume)
    ...
    lash_e.nr_robot.dispense_into_wellplate(well_plate_array, [aspirate_volume/6, aspirate_volume/6, aspirate_volume/6])

    lash_e.nr_robot.finish_pipetting()

    #Transfer the well plate to the cytation and measure
    lash_e.measure_wellplate(cytation_protocol_file_path,0)
