...
repeats = 3
open_vials = [1]
vial_names = ["Sample", "Solvent"] #Label the vials by number, can improve this later
...
for volume in volumes:
    ...
    for i in range (0, repeats):
        ...
        mass_pipetted = nr.pipet_from_vial_into_vial(1, 0, volume,measure_weight=True, aspirate_conditioning=False)
