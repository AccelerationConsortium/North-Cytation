...
obj1_name = "deviation"
obj2_name = "time"  # Raw time in seconds - no transformations
...
def add_result(ax_client, trial_index, results):
    """Add results for deviation and raw time (no transformations).
    ...
    # Only use deviation and raw time (ignore variability)
    data = {
