...
def check_stopping_criteria(all_results, volume_ml, tolerances):
    ...
    1. Reached MAX_TRIALS total individual measurements (60), OR
    2. Have MIN_GOOD_TRIALS "good" parameter sets (6)
    
    Note: MAX_TRIALS counts individual measurements, MIN_GOOD_TRIALS counts parameter sets
    ...
    if total_measurements >= MAX_TRIALS:
        return {
            'should_stop': True,
        ...
        return {
            'should_stop': False,
            'reason': f'Need {MIN_GOOD_TRIALS - good_parameter_sets} more good parameter sets or {MAX_TRIALS - total_measurements} more measurements',
            'good_trials': good_parameter_sets,
            'total_trials': total_parameter_sets
        }
