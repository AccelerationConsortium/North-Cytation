...
def create_grid_heatmaps(csv_file_path):
    ...
    # Save the processed grid data as CSV files
    turbidity_csv = output_dir / 'turbidity_grid_data.csv'
    ratio_csv = output_dir / 'ratio_grid_data.csv'
    controls_csv = output_dir / 'control_data.csv'
    
    turbidity_grid.to_csv(turbidity_csv)
    ratio_grid.to_csv(ratio_csv)
    control_df.to_csv(controls_csv, index=False)
    
    print(f"Turbidity grid data saved to: {turbidity_csv}")
    print(f"Ratio grid data saved to: {ratio_csv}")
    print(f"Control data saved to: {controls_csv}")
