#!/usr/bin/env python3
"""
Run spectral analysis on the IDT-TIT heptane samples (1000x)
"""
...
# Target folder
folder_path = "/Users/serenaqiu/Downloads/p(IDT-TIT)_1000x_HCl_heptane/p(IDT-TIT)_1000x_HCl_heptane"

# Create processed data subdirectory in the target folder
processed_data_dir = f"{folder_path}/processed_data_new"
